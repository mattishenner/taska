...
(0, _auth.onAuthStateChanged)((0, _appJs.auth), (user)=>{
    if (user) {
        ...
        async function getTasks() {
            const taskSnapshot = await (0, _firestore.getDocs)((0, _firestore.collection)((0, _appJs.db), "users", (0, _appJs.auth).currentUser.uid, "tasks"));
...
},{"firebase/firestore":"8A4BC","./app.js":"igcvL","@firebase/auth":"khbwD"}]},["9U7b9","h9tGv"], "h9tGv", "parcelRequireec8e")
